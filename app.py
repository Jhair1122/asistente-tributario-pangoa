...
def predecir_respuesta(pregunta_usuario):
    ...
    if modelo is None or vectorizer is None or label_encoder is None:
        return "⚠️ El modelo aún no está disponible. Sube los archivos .pkl al repositorio."
...
.chip:hover {
    background: #145c32; color: #ffffff;
    border-color: #145c32; transform: translateY(-1px);
